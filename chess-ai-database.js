    ...
    masterGames: [
        ...
        },
        {
            ...
            moves: [
                ...
                "b3-a4", "c8-b7", "a4xc6", "b7xc6", "b5xc6", "e7xc6",
                "a3-b4", "a5xb4", "c3xb4", "b8xb4", "a1-c1", "b4-b2",
                "c1xc6", "b2xa2", "c6-c8", "e8-d7", "c8-c7", "d7-d6",
                "e1-d1", "a2-a1", "d1xa1", "g6-b6", "c7-c6", "b6xc6"
            ],
            keyMoments: [
        ...
        },
        {
            ...
            moves: [
                ...
                "a2-a3", "e7-e5", "e1-c1", "d8-e7", "c1-b1", "a7-a6",
                "e2-c1", "e8-c8", "c1-b3", "e5-e4", "d4-d5", "f6xd5",
                "h6-d2", "e4xf3", "g2xf3", "d5-e3", "d2xd6", "e3-c4",
                "d6-d8", "e7xd8", "h1xd8", "c8xd8", "d1xd8"
            ],
            keyMoments: [
        ...
        },
        {
            ...
            moves: [
                ...
                "d2-f1", "f8-e8", "f1-e3", "g7-g6", "a2-a4", "c5-c4"
            ],
            keyMoments: [
        ...
        },
        {
            ...
            moves: [
                ...
                "d4xe5", "c6xe5", "a1-d1", "e5-d3", "d2-c2", "a6-f1",
                "e2xf1", "e8-e1", "d1xe1", "d3-f2"
            ],
            keyMoments: [
...
class ChessAILearner {
    ...
    learnFromGame(gameData) {
        this.performanceHistory.push({
            ...
            difficulty: gameData.difficulty || 6
        });
    ...
    analyzeOpening(openingMoves, result, aiColor) {
        ...
        if ((result === '1-0' && aiColor === 'white') || 
            (result === '0-1' && aiColor === 'black')) {
            stats.wins++;
    ...
    getWinRate() {
        ...
        const wins = recentGames.filter(game => 
            (game.result === '1-0' && game.aiColor === 'white') ||
            (game.result === '0-1' && game.aiColor === 'black')
        ).length;
    ...
    adjustDifficulty() {
        ...
        let newDepth = 6; // Default

        if (winRate > 75) newDepth = 7;
        else if (winRate > 85) newDepth = 8;
        else if (winRate < 25) newDepth = 5;
        else if (winRate < 15) newDepth = 4;
